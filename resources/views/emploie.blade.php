   ...
   <body class="bg-gray-100 tracking-wider tracking-normal">
      ...
      <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
               ...
               <ul class="list-reset">
                <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                 ...
                 <li class="py-2 mb-3 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                    <a href="/Empois du temps" class="block pl-4 align-middle text-gray-700 no-underline hover:text-purple-500 border-l-4 border-transparent lg:border-purple-500 lg:hover:border-purple-500">
                    <span class="pb-1 md:pb-0 text-sm text-gray-900 font-bold">Empois du temps</span>
                    </a>
                 </li>
                 <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
         ...
         <div class="w-full lg:w-4/5 p-8 mt-6 lg:mt-0 text-gray-900 leading-normal bg-white border border-gray-400 border-rounded">
            <!--Title-->
            <div class="font-sans">
               <h1 class="font-sans break-normal text-gray-900 pt-6 pb-2 text-xl">Empois du temps</h1>
                  ...
                  <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <div class="flex justify-center">
                      <div class="w-96">
                        ...
                        ease-in-out
                        m-0
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="file" id="emploiFile" name="emploiFile">
                      </div>
                    </div>
                  </div>
                </div>
